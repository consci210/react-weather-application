...
function App() {
  ...
  // Added light and dark mode toggler here 
  ...
  return (
    <>
      ...
      <div className="toggle-container">
        <button  className='light-btn'  onClick={toggleMode}>
          {mode === "light" ? (
